    ...
    <b-container>
      <b-row class="justify-content-center">
        ...
        <b-col cols="auto" class="text-left">
          ...
          <ul class="list-unstyled ml-3">
            <li><a href="https://github.com/custom-bootstrap-vue/custom-bootstrap-vue" target="_blank">GitHub</a></li>
            ...
            <li><a href="https://opencollective.com/custom-bootstrap-vue/" target="_blank">Open Collective</a></li>
          </ul>
      ...
      <p class="mb-2">
        ...
        <a href="https://github.com/orgs/custom-bootstrap-vue/people" target="_blank">core team</a>
        with the help of
        <a href="https://github.com/custom-bootstrap-vue/custom-bootstrap-vue/graphs/contributors" target="_blank">our contributors</a>.
      </p>

      <p>
        Currently v{{ version }}. Code licensed
        <a href="https://github.com/custom-bootstrap-vue/custom-bootstrap-vue/blob/master/LICENSE" target="_blank">MIT</a>.
        Docs generated with
